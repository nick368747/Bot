  ...
  try {
    ...
    mcBot =
      bedrock.createClient({
        ...
        // Microsoft-Login wird hier gespeichert,
        // sofern die Umgebung persistent ist.
        profilesFolder:
          "./.minecraft",
      ...
      if (
        ...
        if (
          ...
          await interaction.reply({
            ...
            content:
              "▶️ FrozenRun wird gestartet. Falls nötig, erscheint gleich der Microsoft-Login-Code.",
